...
/**
 * ServiceVoucher Class Doc Comment
 *
 * @category    Class */
 // @description Service voucher
/** 
 * @package     KuntaAPI
 * @author      http://github.com/swagger-api/swagger-codegen
 * @license     http://www.apache.org/licenses/LICENSE-2.0 Apache Licene v2
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ServiceVoucher implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'ServiceVoucher';
     ...
     * @param string $additionalInformation Service voucher additional information
     * @return $this
     */
